...
btnHome.addEventListener("click", () => {
    ...
    main.innerHTML = `
                        ...
                        <div class="div-home-img">
                            <div class="row">
                                <img id="img-front-page" src="./media/Front-page.jpeg" alt="Front page">
                            </div>
                        </div>
                        `;
}) 
...
btnProducts.addEventListener("click", () => {
    ...
    main.innerHTML = "";
    main.innerHTML += `
                        <div id="product${1}" class="div-products">
                            <h4>${"My Foundation"}</h4>
...
btnShoppingCart.addEventListener("click", () => {
    ...
    main.innerHTML += `
                        ...
                        <div id="div-sc-secondary" style="background-color: #f0e3db">
                            <h3>Total</h3>
                            <p>${"$20"}</p>
                        </div>
                        `;
